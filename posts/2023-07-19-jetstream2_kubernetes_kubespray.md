...
Open and modify `cluster.tfvars`, choose your image (by default Ubuntu 20, **Update February 2024, currently Ubuntu 22 works on CPU but [broken on GPU](https://github.com/zonca/jupyterhub-deploy-kubernetes-jetstream/issues/73)) and number of nodes and the flavor of the nodes, by default they are medium instances (`"4"`).
