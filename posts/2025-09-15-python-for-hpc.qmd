...
This is part of the [Advanced HPC-CI Webinar series](https://www.sdsc.edu/education/training-programs/Advanced-HPC-CI-Webinars.html). This webinar was authored by P. Zonca, Lead of Scientific Computing Applications Group at the San Diego Supercomputer Center. You can find more about P. Zonca here: [https://www.sdsc.edu/research/researcher_spotlight/zonca_andrea.html](https://www.sdsc.edu/research/researcher_spotlight/zonca_andrea.html).

This video provides a detailed guide on using Python for High-Performance Computing (HPC). It covers essential techniques for optimizing Python code and leveraging supercomputing resources.
