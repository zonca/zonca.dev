...
This guide is for **existing clusters** already running JupyterHub with
`ingress-nginx`. For new clusters, see the
[4-post tutorial series](./2026-08-20-kubernetes-jetstream2-magnum.md).
